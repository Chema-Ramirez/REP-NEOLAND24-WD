...
const starWarsInfo = {
        ...
        /*Queremos cambiar el nombre del director a "Irvin Kershner"
        solo si el año de estreno de la película es anterior a 1980.
        ...
        //? ** Ejercicio 5: Cambiar la especie de Darth Vader a "Sith"
        /*Si su nombre es "Anakin Skywalker" **
        ...
        1. Cambia la especie de Darth Vader a `"Sith Lord"` y añade `"Boba Fett"` a su lista de aliados pero solo si su nombre es 
        `"Darth Vader"` ** y ** su planeta de origen(`homeworld`) es `"Tatooine"`.
        
        2. Si la lista de aliados de Luke Skywalker contiene a `"Obi-Wan Kenobi"`, añade también a `"Yoda"` como su aliado.

        3. Verifica si el director de la película es `"George Lucas"` y, si es así, añade una nueva propiedad `producer`
        con el valor `"Lucasfilm"` en el nivel de la película.
